# SFPD-ServiceCalls
Sample NodeJS server implementation for San Francisco PD service calls database records.

Provides basic HTTP operations for storing service call records in Postgres DB. Intended to be used
